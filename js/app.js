(() => {
    ...
    function initSliders() {
        if (document.querySelector(".four-page")) new core(".four-page__slider", {
    ...
    window.onload = function() {
        document.querySelectorAll(".mud-paper").forEach((n => {
            const name = n.querySelector(".mud-typography");
            const link = n.querySelector(".mud-chip");
            if (link) name.classList.toggle("is-notactive"); else if (void 0 == link) name.classList.remove("is-notactive");
        }));
    };
    window["FLS"] = true;
    isWebp();
